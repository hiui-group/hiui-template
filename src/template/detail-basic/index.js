...
export default class Template extends Component {
  ...
  render () {
    ...
    return (
      <React.Fragment>
        <div className='detail-basic detail-basic__header'>
        ...
        <div className='detail-basic detail-basic__body page page--gutter'>
