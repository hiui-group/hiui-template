...
const prefix = 'page--tree-multiple-query'
const queryData = {
  selectedRowKey: 'id',
  total: 20,
  current: 1,
      ...
      <Row style={{ alignItems: 'flex-start' }}>
        {visible ? (
          <Tree
            ...
            onCheck={(checked, checkedKeys, checkedNode) => {
              console.log('Tree data:', checkedKeys, checked, checkedNode)
              onValuesChange(checkedKeys.checkedIds)
            }}
          />
        ) : null}
      </Row>
      <div className={`${prefix}__filter-submit`}>
        <Button className="primary-inverted" type="default" onClick={onReset}>
          重置
        </Button>
