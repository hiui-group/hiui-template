...
function createAdvice(hostProfile, recommendedMode = hostProfile.recommendedMode) {
  ...
  if (recommendedMode === 'legacy-host-compatible') {
    return {
      ...
      summary:
        'This target should keep its current runtime and host container contract. Reuse the page-type semantics and structure rhythm, but do not mount the standard @hiui-design/typical-page-shells runtime in this host.',
      steps: [
        'Use `legacy-host-compatible` mode and keep the existing route/layout system.',
        'Do not import `@hiui-design/typical-page-shells` in newly generated pages unless you first isolate a dedicated modern runtime entry.',
