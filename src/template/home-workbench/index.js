...
export default class Workbench extends Component {
  ...
  async componentDidMount() {
    ...
    } = await Axios.get('https://yapi.baidu.com/mock/64112/hiui/workbench/info')
  ...
  updateWaitToBeDoneInfos = async nowPage => {
    ...
    const urlPath = `https://yapi.baidu.com/mock/64112/hiui/workbench/waitToBeDoneInfos?nowPage=${nowPage}&size=4`
    const {
