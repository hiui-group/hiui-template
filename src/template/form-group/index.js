...
export default class Template extends Component {
  ...
  render() {
    ...
    return (
      <div className="hi-tpl-form__container hi-tpl-form__group__container">
        <p className="hi-tpl-form__title">表单</p>

        <Form ref={this.form} model={forms} rules={this.rules} labelWidth="80">
          <div className="hi-tpl-form__group__content">
            <div className="hi-tpl-form__group__name">Group Name</div>
