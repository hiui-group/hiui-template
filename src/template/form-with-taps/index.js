...
import { Form, Input, Select, Button, DatePicker, Counter, TimePicker, Radio, Upload, Message, Tabs } from '@hi-ui/hiui'
import './index.scss'
...
export default class Template extends Component {
  ...
  render() {
    ...
    return (
      <div className="page--form-with-taps">
        <div className="page--form-with-taps-content">
          <Tabs type="line" placement="vertical" defaultActiveId="tabId-2" onTabClick={(tab, e) => console.log(tab)}>
            {this.state.panes.map((pane, index) => {
              return (
                <Tabs.Pane tabTitle={pane.tabTitle} tabId={pane.tabId} closeable={pane.closeable} key={index}>
                  <Form
                    ref={this.form}
                    rules={rules}
                    labelWidth="70"
                  ...
                  >
                    <h2 className="hi-form__title">{pane.tabTitle}</h2>
        ...
        <div className="page--form-with-taps--footer">
          <Button type="primary" onClick={this.handleSubmit.bind(this)}>
            提交
          </Button>
          <Button type="line" onClick={this.cancelSubmit.bind(this)}>
